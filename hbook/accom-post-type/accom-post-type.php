...
class HbAccommodation {
	...
	public function accommodation_meta_box() {
        ...
        add_meta_box( 'accommodation_side_meta_box', esc_html__( 'Accommodation display', 'hbook-admin' ), array( $this, 'accommodation_side_meta_box_display' ), 'hb_accommodation', 'side' );
	}
    ...
    public function accommodation_side_meta_box_display( $post ) {
		...
		<p class="hb-accom-select-linked-page">
			<label for="hb-accom-linked-page"  class="hb-accom-settings-label"><?php esc_html_e( 'Enter the ID of the page used for displaying the accommodation:', 'hbook-admin' ); ?></label>
        ...
        <p class="hb-accom-select-template">
            <label for="hb-accom-page-template" class="hb-accom-settings-label"><?php esc_html_e( 'Select a template:', 'hbook-admin' ); ?></label>
            <?php
			if ( function_exists( 'htw_is_active' ) ) { 
				$page_templates = array(
					'post' => esc_html__( 'Accommodation post', 'hbook-admin' ),
					'template-advanced-layout.php' => esc_html__( 'Advanced layout Template', 'hbook-admin' ),
				);
			} else {
