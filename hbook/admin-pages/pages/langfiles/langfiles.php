...
class HbAdminPageLangfiles extends HbAdminPage {
	...
	<div class="wrap">
		...
		<?php
		if ( isset( $_POST['hb-import-export-action'] ) && ( $_POST['hb-import-export-action'] == 'import-lang' ) && wp_verify_nonce( $_POST['hb_import_export'], 'hb_import_export' ) && current_user_can( 'manage_options' ) ) {
			...
			?>
				<div class="updated">
					<p><?php printf( esc_html__( 'The import was successful (%d strings have been imported).', 'hbook-admin' ), count( $ids ) ); ?></p>
				</div>
			<?php
			}
		}
