			...
			<div id="hb-block-accom">
				...
				<div class="stuffbox">
					<form data-bind="submit: add_blocked_accom">
						...
						<p  class="hb-add-blocked-accom-column">
							<label for="hb-block-accom-from-date"><?php esc_html_e( 'From:', 'hbook-admin' ); ?></label><br/>
						...
						<p  class="hb-add-blocked-accom-column hb-add-blocked-accom-column-last">
							<label for="hb-block-accom-to-date"><?php esc_html_e( 'To:', 'hbook-admin' ); ?></label><br/>
						...
						<p class="hb-add-blocked-accom-submit">
							<input type="submit" class="button-primary" value="<?php esc_attr_e( 'Block accommodation', 'hbook-admin' ); ?>" />
				...
				<div class="hb-table hb-blocked-accom-table">
					...
					<div class="hb-table-row hb-clearfix">
						<div data-bind="attr: { class: anim_class }">
							<div class="hb-table-data hb-table-data-accom" data-bind="text: accom_name_num"></div>
